...
#define TOTAL_EFFECTS 9  // количество эффектов
#define TIME_BETWEEN_MODES 100000
...
void loop() {
  ...
  if (butt1.isSingle() || (timerForNextMode >= TIME_BETWEEN_MODES)) {
    timerForNextMode = 0;
    currentEffect++;
